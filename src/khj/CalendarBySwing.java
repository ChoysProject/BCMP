...
public class CalendarBySwing extends JFrame implements WindowListener, ActionListener, ItemListener {
	...
	public CalendarBySwing(OrderManagement order) {
		this.order = order;
...
//		this.setDefaultCloseOperation(EXIT_ON_CLOSE);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		order.year.setSelectedItem(Integer.parseInt(year));
		order.month.setSelectedItem(Integer.parseInt(month));
		order.day.removeAllItems();
		order.day.addItem("일");
		...
		order.day.setSelectedItem(Integer.parseInt(day));
	}
