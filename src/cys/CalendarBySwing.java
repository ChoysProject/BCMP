...
public class CalendarBySwing extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	public CalendarBySwing(Item_info ii) {
		item = ii;
...
//		this.setDefaultCloseOperation(EXIT_ON_CLOSE);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		break;
		default: for(int d = 1; d<=33;d++) {
			item.choice[5].addItem(d);
		}
		break;
		}
		item.choice[5].setSelectedItem(
